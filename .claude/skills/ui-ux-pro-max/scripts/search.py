...
if __name__ == "__main__":
    ...
    if args.design_system:
        ...
        if args.persist:
            ...
            print(f"   \U0001F4C4 design-system/{project_slug}/MASTER.md (Global Source of Truth)")
            if args.page:
                page_filename = args.page.lower().replace(' ', '-')
                print(f"   \U0001F4C4 design-system/{project_slug}/pages/{page_filename}.md (Page Overrides)")
            print("")
            print(f"\U0001F4D6 Usage: When building a page, check design-system/{project_slug}/pages/[page].md first.")
